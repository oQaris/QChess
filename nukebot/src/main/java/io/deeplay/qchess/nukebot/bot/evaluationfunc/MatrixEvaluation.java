...
public class MatrixEvaluation {
    ...
    public static int figureAttackHeuristics(final GameSettings gs, final Color myColor) {
        return gs.board.getDiffPseudoLegalMovesCount(gs, myColor);
    }
    ...
    public static int ultimateHeuristics(final GameSettings gs, final Color myColor) {
        return 100 * PestoEvaluation.pestoHeuristic(gs, myColor)
                + 20 * figurePositionHeuristics(gs, myColor)
                + figureAttackHeuristics(gs, myColor);
    }
}
