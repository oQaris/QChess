...
public class PestoEvaluation implements Evaluation {
    ...
    private final int[] mg_pawn_table = {
        0, 0, 0, 0, 0, 0, 0, 0,
    ...
    private final int[] eg_pawn_table = {
        0, 0, 0, 0, 0, 0, 0, 0,
    ...
    private final int[] mg_knight_table = {
    ...
    private final int[] eg_knight_table = {
    ...
    private final int[] mg_bishop_table = {
    ...
    private final int[] eg_bishop_table = {
    ...
    private final int[] mg_rook_table = {
    ...
    private final int[] eg_rook_table = {
    ...
    private final int[] mg_queen_table = {
    ...
    private final int[] eg_queen_table = {
    ...
    private final int[] mg_king_table = {
    ...
    private final int[] eg_king_table = {
