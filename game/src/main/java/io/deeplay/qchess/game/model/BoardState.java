...
public class BoardState {
    ...
    public int hashCode() {
        ...
        int result = (h1 * 10 + (hasMovedBeforeLastMove ? 1 : 0)) * 100 + peaceMoveCount;
        result = 31 * result + forsythEdwards.hashCode();
        if (removedFigure != null) result = 31 * result + removedFigure.hashCode();
        return result;
    }
}
